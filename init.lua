...
vim.opt.title = true -- Enable sending title to terminal
vim.opt.titlestring = '%f' -- %f expands to the current buffer's file name
...
{"n", "<c-_>",      function() Snacks.terminal(nil, { cwd = LazyVim.root() }) end, { desc = "which_key_ignore" },
